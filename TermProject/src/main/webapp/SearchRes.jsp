    ...
    <div class="w3-content">
        <div class="w3-twothird">
            ...
            <form action="EmpHome" method="post">
      		<input type="hidden" name="FORM_SUBMITTEDEdit" value="Edit_FORM">
			...
			<input type="text" placeholder="sin_no" id="sin_no" name="sin_no" value="${sin_no}"><br><br>
			...
			<input type="savings" placeholder="savings" id="savings" name="savings" value="${savings}"><br><br>
			
			<label for="checking">Savings Account</label>
			<input type="checking" placeholder="savings" id="checking" name="checking" value="${checking}"><br><br>
